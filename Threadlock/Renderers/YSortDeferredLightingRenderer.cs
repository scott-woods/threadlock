...
using PolygonMesh = Nez.DeferredLighting.PolygonMesh;
using System.Linq;
...
namespace Threadlock.Renderers
{
    ...
    /// </summary>
    public class YSortDeferredLightingRenderer : Renderer
    {
        /// <summary>
        ...
        public YSortDeferredLightingRenderer(int renderOrder, int lightLayer, params int[] renderLayers) : base(renderOrder)
        {
        ...
        public YSortDeferredLightingRenderer SetAmbientColor(Color color)
        {
        ...
        /// <param name="color">Color.</param>
        public YSortDeferredLightingRenderer SetClearColor(Color color)
        {
        ...
        void RenderSprites(Scene scene)
        {
            ...
            var renderables = YSortRenderer.GetSortedRenderablesByLayers(scene, scene.Camera, RenderLayers.ToList());
